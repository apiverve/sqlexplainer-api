...
namespace APIVerve.API.SQLExplainer
{
    ...
    /// <summary>
    /// Client for the SQLExplainer API
    /// </summary>
    public class SQLExplainerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sqlexplainer";
        ...
        {
            { "query", new ValidationRule { Type = "string", Required = true } },
            { "detail", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public SQLExplainerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SQLExplainerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SQLExplainerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SQLExplainerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SQLExplainerQueryOptions options)
        {
        ...
        public ResponseObj Execute(SQLExplainerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SQLExplainerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SQLExplainerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SQLExplainerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SQLExplainerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SQLExplainerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SQLExplainerQueryOptions options)
        {

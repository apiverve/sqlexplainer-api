...
```gradle
dependencies {
    implementation 'com.github.apiverve:sqlexplainer-api:1.1.12'
}
```
...
SQLExplainerAPIClient client = new SQLExplainerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sqlexplainer](https://docs.apiverve.com/ref/sqlexplainer)
...
- **Documentation:** [https://docs.apiverve.com/ref/sqlexplainer](https://docs.apiverve.com/ref/sqlexplainer)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sqlexplainer-api/issues)

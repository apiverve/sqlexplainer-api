# SQL Explainer API - Examples

This folder contains example code for using the SQL Explainer API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/sqlexplainer',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/sqlexplainer");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/sqlexplainer](https://docs.apiverve.com/ref/sqlexplainer)
